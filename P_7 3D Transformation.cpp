...
// float x1,x2;
// float y1,y2;
void draw_cube(float edge[20][3])
{
    float x1, x2;
    float y1, y2;
    int i;
...
void translate(float edge[20][3])
{
    int a, b, c;
    int i;
...
int main()
{
    ...
    int n;
    float edge[20][3] = {100, 0, 0, 100, 100, 0, 0, 100, 0, 0, 100, 100, 0, 0, 100, 0, 0, 0, 100,
                         0, 0,
